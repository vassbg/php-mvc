 ...
 *   Използване:
 *   View::render(admin/users);      -> извиква файл users.php от папка admin в изгледите. Не предава данни
 *   View::render(admin/users, $data); -> същото но предава променливите в масива $data към изгледа
 *
